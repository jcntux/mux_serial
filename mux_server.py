...
class MuxServer(object):
    ...
    def add_client(self, client):
        logio('MUX > New connection from', client.getpeername())
    ...
    def remove_client(self, client, why='?'):
        ...
        logio('MUX > Closing %s: %s' % (name, why))
